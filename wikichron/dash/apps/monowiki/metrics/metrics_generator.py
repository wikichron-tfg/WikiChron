...
def generate_monowiki_metrics():
    ...
    metrics.append(BarGraph('users_edits_tenure_abs', 'By tenure (absolute)', MetricCategory.DISTRIBUTION_OF_ACTIVE_REGISTERED_USERS, monowiki_stats.users_first_edit_abs, 'Distribution of editors by their time participating in the wiki (absolute)', 'Dist. of active registered users by tenure (absolute)'))
    ...
    metrics.append(BarGraph('users_last_edit_abs', 'By date of the last edit (absolute)', MetricCategory.DISTRIBUTION_OF_ACTIVE_REGISTERED_USERS, monowiki_stats.users_last_edit_abs, 'Distribution of editors by their last edit in the wiki (absolute)', 'Dist. of active registered users by date of the last edit (absolute)'))
    ...
    metrics.append(BarGraph('added_factoids_by_last_edit', 'Added factoids by users by the date of last edit', MetricCategory.DISTRIBUTION_OF_FACTOIDS_ACROSS_REGISTERED_USERS, monowiki_stats.added_factoids_by_date_of_last_edit, 'Added factoids by users by the date of last edit', 'Number of added factoids by users by the date of last edit.'))
    metrics.append(BarGraph('deleted_factoids_by_last_edit', 'Deleted factoids by the date of last edit', MetricCategory.DISTRIBUTION_OF_FACTOIDS_ACROSS_REGISTERED_USERS, monowiki_stats.deleted_factoids_by_date_of_last_edit, 'Deleted factoids by users by the date of last edit', 'Number of deleted factoids by users by the date of last edit.'))
