...
def generate_monowiki_metrics():
    ...
    metrics.append(BarGraph('percentage_of_edits_tenure', 'By tenure (absolute)', MetricCategory.DISTRIBUTION_OF_EDITS_ACROSS_REGISTERED_USERS, monowiki_stats.number_of_edits_by_tenure_abs, 'Distribution of edits across distribution of editors by their time participating in the wiki (absolute)', 'Dist. of edits across registered users y tenure (absolute)'))
